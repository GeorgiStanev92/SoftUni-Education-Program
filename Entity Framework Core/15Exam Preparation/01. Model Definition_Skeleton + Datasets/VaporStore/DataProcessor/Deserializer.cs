namespace VaporStore.DataProcessor
{
    ...
    public static class Deserializer
	{
		public static string ImportGames(VaporStoreDbContext context, string jsonString)
		{
			...
			var games = JsonConvert.DeserializeObject<GameInputDto[]>(jsonString);

			List<Game> dbGames = new List<Game>();
			List<Developer> deves = new List<Developer>();
			...
			foreach (var game in games)
            {
				...
				Developer dev = deves.FirstOrDefault(d => d.Name == game.Developer);
				if (dev == null)
                {
		...
		public static string ImportUsers(VaporStoreDbContext context, string jsonString)
		{
			...
			var users = JsonConvert.DeserializeObject<UserInputDto[]>(jsonString);
		...
		public static string ImportPurchases(VaporStoreDbContext context, string xmlString)
		{
			...
			XmlSerializer xmlSerializer = new XmlSerializer(typeof(PurchaseInputDto[]),xmlRoot);
			PurchaseInputDto[] purchases;
			List<Purchase> dbPurchases = new List<Purchase>();

            using (StringReader sr = new StringReader(xmlString))
            {
				purchases = (PurchaseInputDto[])xmlSerializer.Deserialize(sr);
