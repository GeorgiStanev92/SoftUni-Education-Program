...
namespace WarCroft.Core
{
	public class WarController
	{
		...
		public string GetStats()
		{
            ...
            foreach (var item in characters)
            {
				sb.AppendLine(string.Format(SuccessMessages
					.CharacterStats, item.Name, item.Health, item.BaseHealth, item.Armor, item.BaseArmor, item.IsAlive ? "Alive" : "Dead"));
            }
			return sb.ToString();
		}
		...
		public string Attack(string[] args)
		{
			...
			string output = string.Format(SuccessMessages.AttackCharacter, attacker.Name, receiver.Name, attacker.AbilityPoints,
		...
		public string Heal(string[] args)
		{
			...
			string output = string.Format(SuccessMessages.HealCharacter, healer.Name, receiver.Name
				, healer.AbilityPoints, receiver.Name, receiver.Health);
